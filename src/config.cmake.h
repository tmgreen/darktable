...
#define DARKTABLE_LIBDIR "@RUNTIME_INSTALL_PREFIX@/@LIB_INSTALL@"
#define DARKTABLE_DATADIR "@RUNTIME_INSTALL_PREFIX@/@SHARE_INSTALL@"

#ifdef __WIN32__
#define PLUGIN_FILE_ENDING ".dll"
#else
#define PLUGIN_FILE_ENDING ".so"
#endif
